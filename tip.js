...
const calculateBill = () => {
    ...
    //   const perPersonTotalupdate=document.getElementById('perPersonTotal')
    //   perPersonTotalupdate.innerText=`$${PerPersonTotaldiv.toLocaleString('en-US').toFixed(2)}`
    PerPersonTotaldiv.innerText = `$${perPersonTotal.toFixed(2).toLocaleString('en-US')}`
    //.toLocaleString('en-US') one work at a time..one function
}
